...
const routes = [
    ...
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~home-home-module~res-detail-res-detail-module~res-list-res-list-module"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule),
        canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'list',
    ...
    {
        path: 'res-list/:type',
        loadChildren: () => Promise.all(/*! import() | res-list-res-list-module */[__webpack_require__.e("default~home-home-module~res-detail-res-detail-module~res-list-res-list-module"), __webpack_require__.e("res-list-res-list-module")]).then(__webpack_require__.bind(null, /*! ./res-list/res-list.module */ "./src/app/res-list/res-list.module.ts")).then(m => m.ResListPageModule),
        canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'res-detail/:type/:id',
        loadChildren: () => Promise.all(/*! import() | res-detail-res-detail-module */[__webpack_require__.e("default~home-home-module~res-detail-res-detail-module~res-list-res-list-module"), __webpack_require__.e("res-detail-res-detail-module")]).then(__webpack_require__.bind(null, /*! ./res-detail/res-detail.module */ "./src/app/res-detail/res-detail.module.ts")).then(m => m.ResDetailPageModule),
        canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }
];
...
let AppComponent = class AppComponent {
    ...
    ngAfterViewInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.backButtonSubscription = this.platform.backButton.subscribe(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    captureImage(useAlbum) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const options = Object.assign({ quality: 100, destinationType: this.camera.DestinationType.FILE_URI, encodingType: this.camera.EncodingType.JPEG, mediaType: this.camera.MediaType.PICTURE }, useAlbum ? { sourceType: this.camera.PictureSourceType.PHOTOLIBRARY } : {});
            this.camera.getPicture(options).then((imageData) => {
                let base64Image = 'data:image/jpeg;base64,' + imageData;
...
let AuthGuard = class AuthGuard {
    constructor(events, router, storage) {
        this.events = events;
        this.router = router;
        this.storage = storage;
    }
...
let LoginComponent = class LoginComponent {
    constructor(googlePlus, fb, formBuilder, toastController, storage, router, menuCtrl, tw, events) {
