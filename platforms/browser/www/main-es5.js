...
module.exports = "<ion-header class=\"network_bg_err\" *ngIf=\"!data_connection\">\n  Network Disconnected\n</ion-header>\n<ion-header class=\"network_bg_success\" *ngIf=\"data_re_connection\">\n  We are back....\n</ion-header>\n\n\n<ion-app>\n  <ion-split-pane contentId=\"main-content\">\n    <ion-menu contentId=\"main-content\" type=\"overlay\">\n      <ion-header>\n        <ion-toolbar>\n          <ion-item *ngIf=\"login_true\">\n            <ion-avatar slot=\"start\" (click)=\"changeProfile()\">\n              <img src=\"{{data.picture}}\">\n            </ion-avatar>\n            <ion-avatar slot=\"start\" *ngIf=\"custom\">\n              <img src=\"{{custom_image}}\">\n            </ion-avatar>\n            <ion-label>{{data.user_name}}</ion-label>\n          </ion-item>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages\">\n            <ion-item [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\">\n              <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\n              <ion-label>\n                {{p.title}}\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n          <ion-menu-toggle>\n            <ion-item>\n             <ion-icon slot=\"start\" name=\"analytics\"></ion-icon>\n              <ion-label>\n                Charts\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n          <ion-menu-toggle>\n            <ion-item (click)=\"onLogout()\">\n             <ion-icon slot=\"start\" name=\"person\"></ion-icon>\n              <ion-label>\n                Logout\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n"
...
module.exports = "<ion-content class=\"vertical-align-content\">\n  <ion-card class=\"welcome-card\">\n    <img src=\"/assets/shapes.svg\" alt=\"\"/>\n    <ion-card-header>\n      <ion-card-title>LogIN</ion-card-title>\n    </ion-card-header>\n    <form [formGroup]=\"loginForm\" (ngSubmit)=\"onLogin()\">\n      <ion-card-content>\n        <ion-item>\n          <ion-label position=\"floating\">Username</ion-label>\n          <ion-input type=\"text\" formControlName=\"username\" [ngClass]=\"{ 'is-invalid': submitted && f.username.errors }\"></ion-input>\n        </ion-item>\n        <div *ngIf=\"submitted && f.username.errors\" class=\"invalid-feedback error_msg\">\n          <ion-text *ngIf=\"f.username.errors.required\" color=\"danger\">Email is required</ion-text>\n        </div>\n        <ion-item>\n          <ion-label position=\"floating\">password</ion-label>\n          <ion-input type=\"password\" formControlName=\"password\" [ngClass]=\"{ 'is-invalid': submitted && f.password.errors }\"></ion-input>\n        </ion-item>\n        <div *ngIf=\"submitted && f.password.errors\" class=\"invalid-feedback error_msg\">\n          <ion-text *ngIf=\"f.password.errors.required\" color=\"danger\">Password is required</ion-text>\n        </div>\n      </ion-card-content>\n      <ion-card-content>\n        <ion-button type=\"submit\" color=\"success\" expand=\"block\">Login</ion-button>\n      </ion-card-content>\n    </form>\n    <ion-card-content>\n        <ion-button color=\"primary\" expand=\"block\" (click)=\"fbLogin()\">Facebook Login</ion-button>\n    </ion-card-content>\n    <div *ngIf=\"login_true\">\n      <p>{{data}}</p>\n      <p>{{userData}}</p>\n    </div>\n    <!-- <ion-card-content>\n        <ion-button color=\"secondary\" expand=\"block\" (click)=\"twitterLogin()\">Login with Pinterest</ion-button>\n    </ion-card-content>\n    <div *ngIf=\"error\">\n      <p>from ERROR</p>\n      <p>{{err_data}}</p>\n    </div> -->\n  </ion-card>\n</ion-content>"
...
var routes = [
    ...
    {
        path: 'home',
        loadChildren: function () { return Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~home-home-module~res-detail-res-detail-module~res-list-res-list-module"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(function (m) { return m.HomePageModule; }); },
        canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'list',
    ...
    {
        path: 'res-list/:type',
        loadChildren: function () { return Promise.all(/*! import() | res-list-res-list-module */[__webpack_require__.e("default~home-home-module~res-detail-res-detail-module~res-list-res-list-module"), __webpack_require__.e("res-list-res-list-module")]).then(__webpack_require__.bind(null, /*! ./res-list/res-list.module */ "./src/app/res-list/res-list.module.ts")).then(function (m) { return m.ResListPageModule; }); },
        canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'res-detail/:type/:id',
        loadChildren: function () { return Promise.all(/*! import() | res-detail-res-detail-module */[__webpack_require__.e("default~home-home-module~res-detail-res-detail-module~res-list-res-list-module"), __webpack_require__.e("res-detail-res-detail-module")]).then(__webpack_require__.bind(null, /*! ./res-detail/res-detail.module */ "./src/app/res-detail/res-detail.module.ts")).then(function (m) { return m.ResDetailPageModule; }); },
        canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }
];
...
module.exports = ".network_bg_err {\n  background-color: red;\n  color: black;\n  padding: 10px;\n}\n\n.network_bg_success {\n  background-color: #32a877;\n  padding: 10px;\n  color: #fff;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, storage, router, alertController, camera, actionsheetCtrl, webview, events, fb, oneSignal, uniqueDevice_id, network) {
        ...
        this.data = {};
        this.device_id = "";
        this.uniqueDevice_id.get().then(function (uid) {
            _this.device_id = uid;
        });
        setInterval(function () {
            _this.network.onDisconnect().subscribe(function () {
                _this.data_connection = false; //some alert msg that netwk has gone 
            });
            _this.network.onConnect().subscribe(function () {
                _this.data_re_connection = true;
                _this.data_connection = true; //some alert msg that netwk has gone 
                setTimeout(function () {
        ...
        this.events.subscribe("name", function (sliderConfig) {
            // alert(JSON.stringify(sliderConfig))
            _this.data = sliderConfig;
            _this.login_true = true;
        });
    }
    ...
    AppComponent.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.storage.get("current_user_info").then(function (res) {
            // console.log(res, "UUUU")
    ...
    AppComponent.prototype.getUserMenuInfo = function () {
        var _this = this;
        this.storage.get("current_user_info").then(function (res) {
            // console.log(res, "UUUU")
            _this.data = JSON.parse(res);
    ...
    AppComponent.prototype.changeProfile = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AppComponent.prototype.captureImage = function (useAlbum) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var options;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                options = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ quality: 100, destinationType: this.camera.DestinationType.FILE_URI, encodingType: this.camera.EncodingType.JPEG, mediaType: this.camera.MediaType.PICTURE }, useAlbum ? { sourceType: this.camera.PictureSourceType.PHOTOLIBRARY } : {});
                this.camera.getPicture(options).then(function (imageData) {
                    var base64Image = 'data:image/jpeg;base64,' + imageData;
                    var imagePath = _this.webview.convertFileSrc(imageData);
                    _this.custom_image = imagePath;
                    _this.data.picture = imagePath;
                    // this.storage.get("current_user_info").then(res=>{
                    //   var temp = JSON.parse(res)
                    //   temp.picture = this.custom_image
                    //   // final_img = temp
                    // })
                    _this.storage.set("current_user_info", _this.data);
                    _this.storage.get("current_user_info").then(function (res) {
    ...
    AppComponent.prototype.onLogout = function () {
        var _this = this;
        this.login_true = false;
        this.storage.get('provider').then(function (res) {
            if (res) {
                _this.fb.logout();
            }
        });
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.oneSignal.startInit('d5e9e3d9-9534-4ad1-bad2-124a65ed3862', _this.device_id);
            _this.oneSignal.inFocusDisplaying(_this.oneSignal.OSInFocusDisplayOption.None);
            // Notifcation was received in general
            _this.oneSignal.handleNotificationReceived().subscribe(function (data) {
                var msg = "Hello Android";
                var title = "You got a notification";
                // this.showAlert(title, msg);
            });
            _this.network.onDisconnect().subscribe(function () {
                // alert("Network Disconnected")
                _this.data_connection = false;
            });
            _this.network.onConnect().subscribe(function () {
                // alert("Network Disconnected")
                _this.data_re_connection = true;
    ...
    ], AppComponent.prototype, "getUser", void 0);
...
/* harmony import */ var _ionic_native_pinterest_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/pinterest/ngx */ "./node_modules/@ionic-native/pinterest/ngx/index.js");
/* harmony import */ var _ionic_native_twitter_connect_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/twitter-connect/ngx */ "./node_modules/@ionic-native/twitter-connect/ngx/index.js");
...
/* harmony import */ var _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @ionic-native/geolocation/ngx */ "./node_modules/@ionic-native/geolocation/ngx/index.js");
/* harmony import */ var _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @ionic-native/date-picker/ngx */ "./node_modules/@ionic-native/date-picker/ngx/index.js");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [_app_component__WEBPACK_IMPORTED_MODULE_11__["AppComponent"]],
            imports: [
            ...
            providers: [
                ...
                _ionic_native_pinterest_ngx__WEBPACK_IMPORTED_MODULE_15__["Pinterest"],
                _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_23__["DatePicker"],
                _ionic_native_twitter_connect_ngx__WEBPACK_IMPORTED_MODULE_16__["TwitterConnect"],
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(events, router, storage) {
        this.events = events;
        this.router = router;
        this.storage = storage;
    }
    AuthGuard.prototype.canActivate = function (next, state) {
        var _this = this;
        return this.storage.get('current_user').then(function (res) {
            if (res === true) {
                _this.storage.get('current_user_info').then(function (res) {
                    console.log('&&&&&');
                    _this.events.publish('name', JSON.parse(res));
                });
                return true;
            }
            else {
    ...
    AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Events"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
module.exports = ".vertical-align-content {\n  margin-top: 200px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _ionic_native_twitter_connect_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic-native/twitter-connect/ngx */ "./node_modules/@ionic-native/twitter-connect/ngx/index.js");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(googlePlus, fb, formBuilder, toastController, storage, router, menuCtrl, tw, events) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.submitted = true;
                        if (!this.loginForm.invalid) return [3 /*break*/, 1];
                        console.log("failed");
                        return [2 /*return*/];
                    case 1:
                        if (!(this.username_pre === this.loginForm.controls['username'].value && this.password_pre === this.loginForm.controls['password'].value)) return [3 /*break*/, 2];
                        this.storage.set('current_user', true);
                        info_nr = { user_name: "Nyros", picture: "https://nyros.com/images/favicon.ico" };
        ...
        this.fb.login(['public_profile', 'email'])
            ...
            if (res) {
                ...
                _this.fb.api('me?fields=id,name,email,first_name,picture.width(720).height(720).as(picture_large)', []).then(function (profile) {
                    ...
                    _this.userData = JSON.stringify(y);
                    _this.storage.set('current_user_info', JSON.stringify(y));
                    // this.events.publish('name', y)
                    // alert(JSON.stringify(y))
                    _this.storage.set('current_user', true);
                    _this.storage.set('provider', "facebook");
    ...
    LoginComponent.ctorParameters = function () { return [
        ...
        { type: _ionic_native_twitter_connect_ngx__WEBPACK_IMPORTED_MODULE_8__["TwitterConnect"] },
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_7__["GooglePlus"],
            ...
            _ionic_native_twitter_connect_ngx__WEBPACK_IMPORTED_MODULE_8__["TwitterConnect"],
...
module.exports = __webpack_require__(/*! /home/nyros/Documents/nageswararao/Ionic/test_task1/src/main.ts */"./src/main.ts");
