...
var HomeListComponent = /** @class */ (function () {
    function HomeListComponent(storage, _resService, http, toast, router, events, geoLocation) {
    ...
    HomeListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._resService.getAllResData("future", 2).then(function (res) {
            setTimeout(function () {
                _this.future_reservations = res.data;
            });
        });
        var latitudeDync;
        var longitudeDync;
    ...
    HomeListComponent.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    HomeListComponent.prototype.ionViewWillEnter = function () {
        var _this = this;
        this._resService.getAllResData("future", 2).then(function (res) {
            setTimeout(function () {
                _this.future_reservations = res.data;
    ...
    HomeListComponent.prototype.ionViewDidLoad = function () {
        var _this = this;
        this._resService.getAllResData("future", 2).then(function (res) {
            setTimeout(function () {
                _this.future_reservations = res.data;
    ...
    HomeListComponent.prototype.ionViewWillLoad = function () {
        var _this = this;
        this._resService.getAllResData("future", 2).then(function (res) {
            setTimeout(function () {
                _this.future_reservations = res.data;
    ...
    HomeListComponent.prototype.getFutureRes = function (item) {
        console.log(item);
        this.router.navigate(['res-detail', "future", item.id]);
    };
    HomeListComponent.prototype.onFutureAllRes = function () {
